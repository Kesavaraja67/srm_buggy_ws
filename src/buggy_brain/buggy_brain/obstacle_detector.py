...
class ObstacleDetector(Node):
    ...
    def __init__(self):
        ...
        self.stop_distance   = 0.8   # stop if obstacle closer than this
        self.clear_distance  = 1.2   # resume only when obstacle beyond this
        self.front_arc_deg   = 20.0  # degrees — only check front-facing arc
